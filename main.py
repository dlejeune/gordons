...
class Base:
    def __init__(self, internal_base_id, external_base_id,
                 start_time, end_time, num_judges, base_name="", base_staff_description ="", base_scout_description="", base_location="", base_type="", marks=""):
        # self.base_id = base_id
...
class Judge:
    ...
    def __init__(self, judge_id, name, competence, is_special=False, abbreviation=""):
    ...
    def as_dict(self):
        return {"judge_id": self.judge_id,
                ...
                "bases": [base.internal_id for base in sorted(self.bases)]}
...
def load_full_schedule_from_json(base_file, judge_file):
    ...
    for judge in judge_json:
        gordons.add_judge(Judge(judge["judge_id"],
                            judge["name"],
                            judge["competence"], judge["is_special"]))
